...
import { data } from "../ComboChart/stories-data";

import { XcontrolChart } from "./XcontrolChart";


export default {
  title: "static-viz/XcontrolChart",
  component: XcontrolChart,
};

const Template: ComponentStory<typeof XcontrolChart> = args => {
  return (
    <div style={{ border: "1px solid black", display: "inline-block" }}>
      <XcontrolChart {...args} isStorybook />
    </div>
  );
};
...
export const TrendXcontrol = Template.bind({});
TrendXcontrol.args = {
...
export const TrendXcontrolPower = Template.bind({});
TrendXcontrolPower.args = {
  rawSeries: data.trendComboPower as any,
  dashcardSettings: {},
  renderingContext,
};

export const TrendXcontrolLog = Template.bind({});
TrendXcontrolLog.args = {
  rawSeries: data.trendComboLog as any,
  dashcardSettings: {},
  renderingContext,
};

export const XcontrolHistogram = Template.bind({});
XcontrolHistogram.args = {
...
export const XcontrolStackedBarsAreasNormalized = Template.bind({});
XcontrolStackedBarsAreasNormalized.args = {
  rawSeries: data.comboStackedBarsAreasNormalized as any,
  dashcardSettings: {},
  renderingContext,
};

export const XcontrolStackedBarsAreas = Template.bind({});
XcontrolStackedBarsAreas.args = {
...
export const XcontrolDataLabelsAutoCompactnessPropagatesFromLine = Template.bind(
  {},
);
XcontrolDataLabelsAutoCompactnessPropagatesFromLine.args = {
  rawSeries: data.comboDataLabelsAutoCompactnessPropagatesFromLine as any,
  dashcardSettings: {},
  renderingContext,
};

export const XcontrolDataLabelsAutoCompactnessPropagatesFromTotals = Template.bind(
  {},
);
XcontrolDataLabelsAutoCompactnessPropagatesFromTotals.args = {
