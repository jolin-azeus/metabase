...
export const computeStaticXcontrolChartSettings = (
  rawSeries: RawSeries,
  ...
  fillWithDefaultValue(settings, "graph.goal_value", 0);
  fillWithDefaultValue(settings, "graph.goal_label", getDefaultGoalLabel());

  fillWithDefaultValue(settings, "xcontrol.show_custom", true);
  fillWithDefaultValue(settings, "xcontrol.show_goal_label", true);
