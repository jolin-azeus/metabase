...
import { computeStaticXcontrolChartSettings } from "./settings";
...
export const XcontrolChart = ({
  ...
  const computedVisualizationSettings = computeStaticXcontrolChartSettings(
    rawSeries,
    dashcardSettings,
    renderingContext,
  );
